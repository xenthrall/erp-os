    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-6 p-4 md:p-8 max-w-4xl mx-auto w-full pb-32 md:pb-8">
            ...
            <div class="flex items-start gap-4">
                <Link
                    :href="`/customer/warranties/${warranty.id}`"
                ...
                <div class="flex-1">
                    <h1 class="text-2xl font-bold text-slate-900 dark:text-white">
                        Editar Garantía
                        <span class="text-slate-400 dark:text-zinc-500">#{{ warranty.id }}</span>
                    </h1>
                    <p class="text-slate-500 dark:text-slate-400 text-sm mt-1">
                        Modifica los datos de tu solicitud. Solo se pueden editar garantías en estado <strong>Pendiente</strong>.
                    </p>
                </div>
            </div>
            ...
            >
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="flex flex-col">
                            ...
                            <input
                                ...
                                class="w-full mt-2 bg-slate-50 dark:bg-zinc-800 border border-slate-200 dark:border-zinc-700 rounded-xl px-4 py-3 text-slate-900 dark:text-white placeholder-slate-400 shadow-sm focus:outline-none focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-900 transition"
                        ...
                        <div class="flex flex-col">
                            ...
                            <input
                                ...
                                type="date"
                                required
                                class="w-full mt-2 bg-slate-50 dark:bg-zinc-800 border border-slate-200 dark:border-zinc-700 rounded-xl px-3 py-2 text-slate-900 dark:text-white shadow-sm focus:outline-none focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-900 transition"
                        ...
                        <div class="flex flex-col">
                            ...
                            <input
                                ...
                                min="1"
                                required
                                class="w-full mt-2 bg-slate-50 dark:bg-zinc-800 border border-slate-200 dark:border-zinc-700 rounded-xl px-4 py-3 text-slate-900 dark:text-white shadow-sm focus:outline-none focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-900 transition"
                ...
                <section class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="flex flex-col">
                            <label class="text-sm font-medium text-slate-700 dark:text-slate-300">
                                Ciudad de Envío <span class="text-red-500">*</span>
                            </label>
                            <input
                ...
                <section class="space-y-2">
                    <label class="text-sm font-medium text-slate-700 dark:text-slate-300">
                        Descripción detallada de la falla <span class="text-red-500">*</span>
                    </label>
                    <textarea
                        ...
                        class="w-full mt-2 bg-slate-50 dark:bg-zinc-800 border border-slate-200 dark:border-zinc-700 rounded-xl px-4 py-3 text-slate-900 dark:text-white placeholder-slate-400 shadow-sm focus:outline-none focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-900 transition resize-y"
                        :class="{ 'border-red-400': form.errors.failure_description }"
                    ></textarea>
                    <span v-if="form.errors.failure_description" class="text-xs text-red-500 mt-1">
                        {{ form.errors.failure_description }}
                    </span>
                </section>
                ...
                <div class="hidden md:flex items-center justify-end gap-4 pt-2 border-t border-slate-100 dark:border-zinc-800 mt-2">
                    ...
                    <button
                        ...
                        class="inline-flex items-center gap-2 bg-blue-600 text-white px-5 py-2 rounded-lg hover:bg-blue-700 disabled:opacity-70 disabled:cursor-not-allowed transition shadow"
                    >
